...
from src.schemas.constants import FIELD_STRING_REGEX_GROUPS,FIELD_STRING_REGEX_GROUPS_NUM
...
#kiểm tra danh sách các trường field để đảm bảo không có câu hỏi trùng lặp
...
#chuyển từ dạng q1..3 sang thành [q1,q2,q3]
